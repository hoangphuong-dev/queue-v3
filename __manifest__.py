# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'hospital_queue_management/static/src/js/patient_simple_controller.js',  # File mới

            # Templates
            'hospital_queue_management/static/src/xml/coordinator_dashboard_templates.xml',
            ...
            # CSS
            'hospital_queue_management/static/src/scss/coordinator_dashboard.scss',
